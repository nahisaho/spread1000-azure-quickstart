...
| [03](03-property-prediction-gnn/) | **分子物性 GNN (PyG GINE + MoleculeNet ESOL)** | 分子グラフ → 水溶解度予測 (train + evaluate 完全版) | Standard_NC4as_T4_v3 (T4 GPU) | $0.20〜0.50 (¥30〜75) |
...
3. **分子物性 GNN (PyG GINE + MoleculeNet ESOL)** — Graph Neural Network で水溶解度を予測 (train+eval 完全版)
