...
- **デザインシステム**:
  ...
  - **クローム**: 左上に Microsoft 4色マーク + ワードマーク、右下にページ番号のみ (フッターバーなし)
  - **配色ローテーション**: スライドごとに Microsoft 4色 + Fluent 主色を巡回 (各スライドの説明に明記)
...
- **フッターエリア**: 右下ページ番号 1/25 (12pt #605E5C)。フッターバーなし
...
- **フッターエリア**: 右下ページ番号 2/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 3/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 4/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 5/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 6/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 7/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 8/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 9/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 10/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 11/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 12/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 13/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 14/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 15/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 16/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 17/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 18/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 19/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 20/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 21/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 22/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 23/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 24/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
...
- **フッターエリア**: 右下ページ番号 25/25 (12pt #605E5C)。フッターバーなし
- **余白**: 左右 168px / 上下 96px マージン
