...
```bash
cd quickstarts/omics-bioinfo/rnaseq-nextflow/infra
...
curl -sSL https://raw.githubusercontent.com/nahisaho/spread1000-azure-quickstart/main/quickstarts/omics-bioinfo/rnaseq-nextflow/scripts/install-nextflow.sh | bash
