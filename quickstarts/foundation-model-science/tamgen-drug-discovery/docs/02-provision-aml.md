...
cd spread1000-azure-quickstart/quickstarts/foundation-model-science/tamgen-drug-discovery/infra
```
...
```bash
cd quickstarts/foundation-model-science/tamgen-drug-discovery/infra
