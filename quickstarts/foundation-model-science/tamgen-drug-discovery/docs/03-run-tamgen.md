...
# スクリプトを読んで内容を確認 (推奨)
less spread1000-azure-quickstart/quickstarts/foundation-model-science/tamgen-drug-discovery/scripts/setup-tamgen.sh
```

## 3. セットアップスクリプトを実行

```bash
bash spread1000-azure-quickstart/quickstarts/foundation-model-science/tamgen-drug-discovery/scripts/setup-tamgen.sh
```
...
bash ~/spread1000-azure-quickstart/quickstarts/foundation-model-science/tamgen-drug-discovery/scripts/run-inference.sh 3wze 50
```
...
bash ~/spread1000-azure-quickstart/quickstarts/foundation-model-science/tamgen-drug-discovery/scripts/run-inference.sh 5edq 100
```
